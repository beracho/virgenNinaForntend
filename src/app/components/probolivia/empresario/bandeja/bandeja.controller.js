...
import modalpagoController from './bandeja.pago.modal.controller.js';
import modalpagoTemplate from './bandeja.pago.modal.html';

import modalduController from '../duplicar/duplicar.modal.controller.js';
import modalduTemplate from '../duplicar/duplicar.modal.html';
...
class BandejaController {
  ...
  editar(item) {
    // this.$log.log(item)
    this.Storage.setSession('certificacion', item.certificacion.id_certificacion);
